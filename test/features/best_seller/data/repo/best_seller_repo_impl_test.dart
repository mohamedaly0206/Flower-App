  ...
  group('getBestSeller Repository Tests', () {
    ...
    test(
      ...
      () async {
        ...
        when(mockRemoteDataSource.getBestSeller())
            .thenAnswer((_) async => SuccessBaseResponse<BestSellerDto>(data: tBestSellerDto));
        ...
        expect((result as SuccessBaseResponse<ProductsResponseEntity>).data, isA<ProductsResponseEntity>());
    ...
    test(
      ...
      () async {
        ...
        when(mockRemoteDataSource.getBestSeller())
            .thenAnswer((_) async => ErrorBaseResponse<BestSellerDto>(errorMessage: tErrorMessage));
        ...
        expect((result as ErrorBaseResponse<ProductsResponseEntity>).errorMessage, tErrorMessage);

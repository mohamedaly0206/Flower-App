...
import 'package:flower_app/core/shared_features/user_addresses/data/datasources/egypt_locations_local_data_source.dart';
...
import 'package:flower_app/core/shared_features/user_addresses/domain/use_cases/add_address_use_case.dart';
import 'package:flower_app/core/shared_features/user_addresses/domain/use_cases/delete_address_use_case.dart';
import 'package:flower_app/core/shared_features/user_addresses/domain/use_cases/update_address_use_case.dart';
import 'package:flower_app/core/shared_features/user_addresses/domain/use_cases/user_addresses_use_case.dart';
...
class UserAddressesCubit extends Cubit<UserAddressesState> {
  ...
  void _updateCitySelection({required String cityId, required String city}) {
    emit(state.copyWith(cityId: cityId, city: city, clearErrorMessage: true));
  }

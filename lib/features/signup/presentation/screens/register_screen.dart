      ...
      child: BlocConsumer<RegisterCubit, RegisterState>(
        listener: (context, state) {
          ...
          if(state.status==RegisterStatus.success){
            AppMessages.showSuccess(context, message: AppStrings.signUpSuccessMessage);
          }
        },
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              validator: (value) =>
                                  AppValidators.confirmPassword(_passwordController.text, value),
                            ),
                          ),
                        ],
                      ),
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            const TextSpan(
                              text: '${AppStrings.creatingAnAccountYouAgreeToOur} ',
                            ),
                            TextSpan(
